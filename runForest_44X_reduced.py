...
process.schedule = cms.Schedule(process.pcollisionEventSelection,process.pHBHENoiseFilter,process.phiEcalRecHitSpikeFilter,process.ana_step,process.hltAna,process.pAna)
